...
This is a sample template for envelopeApi - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name envelopeapi --query 'Stacks[].Outputs'
```
